  ...
  <section class="space-y-6">
    <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-slate-500">Platform totals from your Laravel LMS backend.</p>
      </div>
...
import { useAdminPanelDashboardStore } from '@/stores/admin/adminDashboardStore'

const dashboard = useAdminPanelDashboardStore()

const icons = [UsersIcon, UserGroupIcon, UserGroupIcon, AcademicCapIcon, BanknotesIcon]
